...
const MetricBento = () => {
  return (
    <div className="grid grid-cols-6 font-mono grid-rows-4 gap-4 w-3/4 h-full">
      ...
      <div className="col-span-2 row-span-2 rounded-3xl bg-linear-to-t from-[#AEDCEF] to-[#E2F7FF] flex flex-col items-center justify-center gap-2 p-6">
        <p className="text-white text-6xl font-bold text-shadow-md">25%</p>
        <p className="text-gray-600 font-sans text-lg">Scored 99+ %ile</p>
      </div>
      ...
      <div className="col-span-2 row-span-2 rounded-3xl bg-linear-to-t from-impact-orange to-[#FED39E] flex flex-col items-center justify-center gap-2 p-6">
        <p className="text-white text-6xl font-bold">50%</p>
        <p className="text-white/80 font-sans text-lg">Scored 95+ %ile</p>
      </div>

      {/* 8000+ Questions / 100+ Tests - col 1-2, row 3-4 */}
      <div className="col-span-2 row-span-2 rounded-3xl bg-orange-300 flex flex-col justify-center gap-1 p-6">
        <p className="text-white text-4xl font-bold">8000+</p>
        <p className="text-white text-4xl font-sans font-bold">Questions</p>
        <p className="text-white text-3xl font-bold mt-2">100+ Tests</p>
      </div>
      ...
      <div className="col-span-4 shadow-2xl row-span-2 rounded-3xl bg-white border border-gray-100 flex items-center justify-center gap-14 p-8">
        <div className="flex flex-col items-center gap-2">
          <Video className="text-orange-400 w-12 h-12" />
          <p className="text-gray-900 text-5xl font-bold">300hrs</p>
        </div>
        <p className="text-gray-900 text-4xl font-sans font-bold leading-tight">
