const CornerFillButton = ({ label }: { label: string }) => (
  <button className="group relative overflow-hidden text-impact-blue hover:text-white font-mono text-md font-bold px-4 py-1 transition-colors duration-300">
    {/* corner borders */}
